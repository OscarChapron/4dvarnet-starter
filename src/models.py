...
class Lit4dVarNet(pl.LightningModule):
    def __init__(self, solver, rec_weight, opt_fn, sampling_rate=None, norm_type='z_score', test_metrics=None, pre_metric_fn=None, norm_stats=None, persist_rw=True):
        super().__init__()
        self.solver = solver
...
class Lit4dVarNet_AE(pl.LightningModule):
    def __init__(self, prior_cost, rec_weight, opt_fn, sampling_rate=0.1, norm_type='z_score', test_metrics=None, pre_metric_fn=None, norm_stats=None, persist_rw=True):
        super().__init__()
    ...
    def step(self, batch, phase=""):
        ...
        mask = torch.rand(batch.input.size(), device=batch.input.device) > self.sampling_rate
        ...
        return autoencoder_loss, batch.input
